    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="project_persons", to="ourprojects.person"
            ),
        ),
        migrations.CreateModel(
            name="Reference",
            fields=[
                ...
                (
                    "pubmed_id",
                    lnschema_core.fields.BigIntegerField(blank=True, null=True),
                ),
                (
                    "doi",
                    lnschema_core.fields.CharField(
                ...
                (
                    "persons",
                    models.ManyToManyField(
                        related_name="reference_persons", to="ourprojects.person"
                    ),
                ),
                (
                    "run",
